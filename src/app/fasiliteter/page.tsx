    ...
    <main className='flex flex-col gap-3 md:gap-6'>
      <div className=' flex flex-col gap-3 md:gap-6'>
        ...
        <ImageTextCard
          ...
          textContainerStyle={'w-full h-full md:w-1/2 lg:w-1/2 md:h-auto xl:w-[1/3] text-dark-text'}
      ...
      <div className='flex flex-col gap-3 md:gap-6'>
        ...
        <ImageTextCard
          ...
          textContainerStyle={'bg-moss-500 text-light-text w-full h-full md:w-1/2 lg:w-1/2 md:h-auto xl:w-[1/3]'}
      ...
      <div className='flex flex-col gap-3 md:gap-6'>
        ...
        <ImageTextCard
          ...
          textContainerStyle={'w-full h-full md:w-1/2 text-dark-text lg:w-1/2 md:h-auto xl:w-[1/3]'}
          paragraphStyle={'lg:my-8 xl:mr-10 lg:text-lg xl:text-xl pt-4 lg:pt-0'}
          largeScreenReverse={false}
          smallScreenReverse={true}
          button={
            <Button href='/#contact-form' variant={'primary'} className={'rounded-md w-full md:w-auto mt-8 lg:text-lg'}>
              Ta kontakt
            </Button>
          }
        />
