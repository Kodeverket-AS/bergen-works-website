    ...
    <main>
      <div className="mb-10">
        <FasiliteterCard
          ...
          buttonStyle="bg-moss-600 text-[var(--text-light)] hover:bg-[#1C2B14] w-full md:w-auto mt-6 lg:text-lg"
      ...
      <div className="mb-10">
        <FasiliteterCard
          ...
          buttonStyle="bg-moss-600 text-[var(--text-light)] hover:bg-[#1C2B14] w-full md:w-auto mt-6 lg:mt-0 lg:text-lg"
          largeScreenReverse={false}
          smallScreenReverse={true}
        />
      </div>
