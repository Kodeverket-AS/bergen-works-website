      ...
      <main className="">
        <div className="mb-10">
          <FasiliteterCard
            ...
            imageContainerStyle={
              " brightness-80 contrast-80 w-full h-[400] md:w-1/2 lg:w-8/12 md:h-[450] rounded-xl"
            }
        ...
        <div className="mb-10">
          <FasiliteterCard
            ...
            headerText={"Flere møterom – alltid en plass for deg i Skostredet"}
            paragraphText={
        ...
        <div className="mb-10">
          <FasiliteterCard
            ...
            headerText={"Lei lokaler til kurs, konferanser og arrangementer"}
            paragraphText={
