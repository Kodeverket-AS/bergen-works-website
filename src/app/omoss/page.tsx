                ...
                <div className='bg-[#606c38] text-[#fffafa] p-8 md:p-10 rounded-2xl shadow-lg flex flex-col md:flex-row items-center gap-6'>
                    ...
                    <div className='text-center md:text-left'>
                        ...
                        <p className='text-lg mb-3'>
                            Daglig leder, Bergen.Works
                        </p>
                        <p className='text-base italic max-w-xl'>
                            &quot;Vårt mål er å gjøre reisen din som gründer
                            litt lettere – og mye mer inspirerende. Vi står
                            klare til å støtte deg med kompetanse, nettverk og
                            ekte engasjement. Kom gjerne innom for en
                            prat!&quot;
                        </p>
