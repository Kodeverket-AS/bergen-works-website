        ...
        <div className='bg-[#606c38] text-[#fffafa] p-8 md:p-10 rounded-2xl shadow-lg flex flex-col md:flex-row items-center gap-6'>
          ...
          <div className='text-center md:text-left'>
            ...
            <p className='text-base italic max-w-xl'>
              &quot;Vårt mål er å gjøre reisen din som gründer litt lettere – og mye mer inspirerende. Vi står klare til
              å støtte deg med kompetanse, nettverk og ekte engasjement. Kom gjerne innom for en prat!&quot;
            </p>
            <div className='mt-4 space-y-1 text-sm'>
              ...
              <p>
                ...
                <a href='tel:+4748502813' className='underline hover:text-chocolate-500 transition-colors duration-200'>
                  +47 485 02 813
                </a>
              </p>
            </div>
