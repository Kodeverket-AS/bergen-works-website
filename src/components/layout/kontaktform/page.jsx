...
import { TextField, Button, Box, Typography, Card, CardContent, CardMedia, Checkbox, FormControlLabel } from '@mui/material';
const ContactForm = () => {
...
// Log form data (you can send this to an API instead)
...
<div className="flex flex-col gap-3 p-10 m-3 lg:flex-row bg-white text-black">
         ...
         <Card className="p-6 bg-white rounded-3xl shadow-lg">
            <CardContent>
               ...
               <Typography variant="body1" className="text-lg">
                  Er du interessert i å bli en del av fellesskapet eller har du noen spørsmål? Fyll ut kontaktskjemaet, så kontakter vi deg forløpende.
               </Typography>
            </CardContent>
         </Card>
         {/* Card for Form */}
   ...
   <div className="flex-1">
      <Card className="w-full h-full rounded-3xl shadow-lg overflow-hidden">
         <CardMedia
            component="img"
            height="100%"
            image="/BW_Bygning.png"
