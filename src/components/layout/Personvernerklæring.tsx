    ...
    <section className="w-full py-24">
        <div className="container mx-auto flex flex-col gap-12 px-4 lg:px-8">
            ...
            <div className="flex flex-col gap-4">
                <h2 className="font-bold">Personopplysninger vi samler inn og behandler</h2>
                <p>Vi behandler følgende kategorier av personopplysninger:</p>

                <ul className="list-disc list-outside flex flex-col gap-2 pl-4">
                    <li>
                    <h3 className="font-bold">Kontaktinformasjon</h3>
                    <p>Adresse, telefonnummer, epostadresse</p>
                    </li>
                    <li>
                        <h3 className="font-bold">Kundehistorikk og kundeengasjement</h3>
                    ...
                    <li>
                        <h3 className="font-bold">Kundeaktivitet</h3>
                        ...
                        <p>Personopplysningene samles inn direkte fra deg gjennom informasjon du oppgir til oss og i forbindelse med at du bruker våre tjenester og produkter.</p>
                            ...
                            <div className="flex flex-col gap-4">
                                <h2 className="font-bold">Hvordan vi bruker personopplysningene</h2>
                                <h3 className="font-bold">Levering av tjeneste/avtaleinngåelse</h3>
                                ...
                                <h3 className="font-bold">Administrasjon av kundeforhold</h3>
                                ...
                                <h3 className="font-bold">Analyse, forretningsutvikling og forbedring av tjenester</h3>
                                ...
                                <h3 className="font-bold">Tilpasset brukeropplevelse</h3>
                                ...
                                <h3 className="font-bold">Salg og markedsføring</h3>
                                ...
                                <div className="flex flex-col gap-4">
                                    <h2 className="font-bold">Dine rettigheter</h2>
                                    ...
                                    <h3 className="font-bold">Rett til innsyn i egne opplysninger</h3>
                                    ...
                                    <h3 className="font-bold">Rett til korrigering av personopplysninger</h3>
                                    <p>Du har rett til å be oss rette eller supplere opplysninger som er feilaktige eller misvisende.</p>
                                    
                                    <h3 className="font-bold">Retten til sletting av personopplysninger</h3>
                                    ...
                                    <h3 className="font-bold">Begrensning av behandling av personopplysninger</h3>
                                    ...
                                    <h3 className="font-bold">Protestere mot en behandling av personopplysninger</h3>
                                    ...
                                    <h3 className="font-bold">Dataportabilitet</h3>
                                    ...
                                    <h3 className="font-bold">Du kan klage på vår behandling av personopplysninger</h3>
