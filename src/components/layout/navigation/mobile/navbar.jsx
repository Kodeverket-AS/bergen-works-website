...
export default function NavBar() {
  ...
  return (
    <nav className='w-full rounded-2xl shadow-navbar lg:flex lg:items-center lg:justify-between'>
      <div className='flex justify-between items-center '>
        <div className='m-6'>
          <Link href='/' scroll={true}>
            <img width={150} height={150} src='/BW_Logo.png' alt='BergenWorks logo' className='rounded-2xl' />
          </Link>
        </div>
        <button
      ...
      >
        <li>
          <Link href='/fasiliteter' className=' hover:underline md:text-lg' onClick={handleLinkClick}>
            Fasiliteter
          </Link>
        </li>
        <li>
          <Link href='/medlemskap' className=' hover:underline md:text-lg' onClick={handleLinkClick}>
            Medlemskap
          </Link>
        </li>
        <li>
          <Link href='/inkubator' className=' hover:underline md:text-lg' onClick={handleLinkClick}>
            Inkubator
          </Link>
        </li>
        <li>
