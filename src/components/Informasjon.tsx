                ...
                <div className='text-[var(--text-light)] w-full px-10 rounded-2xl lg:w-2/3 h-full lg:bg-[#1D1D1D]'>
                    <div className='lg:px-2 3xl:px-10 '>
                        ...
                        <p className='hidden lg:block xl:text-lg mt-2 '>
                            coworking space gir deg tilgang til et inspirerende
                            miljø, nye samarbeidspartnere og økt produktivitet.
                            Hos Bergen.Works har vi ledige plasser for deg som
                            vil jobbe i et dynamisk og sosialt fellesskap –
            ...
            <div className='w-full mt-[1em]  md:w-[550px]  flex flex-col lg:flex-row  lg:w-full justify-around xl:justify-center gap-5 xl:gap-10 '>
                ...
                <div className='text-[var(--text-dark)] lg:w-1/3'>
                    <InfoCard
                        ...
                        textContentStyle={
                            "flex flex-col justify-center p-4 xl:px-8"
                        }
                        headerStyle={"h-full text-2xl  font-bold "}
                        paragraphStyle={"mt-2 text-sm sm:text-base"}
                        arrowStyle={
