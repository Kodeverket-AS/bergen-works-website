...
const SommerKampanje = () => {
    ...
    return (
        <div className='fixed inset-0 bg-black/85 flex items-center justify-center z-50 p-4'>
            <div className='relative text-moss-600 font-work-sans rounded-xl shadow-2xl p-2 sm:p-3 md:p-6 lg:p-7 w-full max-w-[85vw] sm:max-w-sm md:max-w-xl mx-auto transform transition-all duration-300 ease-out scale-100 opacity-100 bg-white/90 max-h-[85vh] md:max-h-[96vh] overflow-y-auto'>
                <button
                    onClick={handleClose}
                ...
                <div className='text-center '>
                    ...
                    <h2 className='text-3xl md:text-4xl font-extrabold mb-3 font-space-grotesk'>
                        Sommerkampanje:
                        <br />{" "}
                    ...
                    <div className='mb-4 flex justify-center'>
                        <Image
                            src='/FastPlass_logo.png'
                            alt='office'
                            width={42}
                            height={42}
                            className='opacity-90 sm:w-[56px] sm:h-[56px]'
                        />
                    </div>
                    ...
                    <div className='mb-4 sm:mb-6'>
                        <h1 className='text-base sm:text-xl leading-relaxed'>
                            ...
                            <strong>
                                {" "}
                                Registrer deg for fast kontorplass før 30.
                                juni{" "}
                            </strong>{" "}
                            , og få én måned gratis leie!{" "}
                        </h1>
                        ...
                        <div className='rounded-xl font-semibold text-sm sm:text-lg leading-6 sm:leading-7 text-glow'>
                            Perfekt for deg som trenger et inspirerende sted å
                            jobbe gjennom sommeren – supert nettverk inkludert.
                        </div>
                    </div>
